...
export const CustomersView = ({ t }) => {
  ...
  const handleSubmit = (e) => {
    ...
    const newCustomer = {
      ...
      purpose: formData.personalUse && formData.investment ? "Personal & Investment" : (formData.investment ? "Investment" : "Personal Use"),
    ...
    alert(`🎉 Success! Customer "${newCustomer.firstName} ${newCustomer.lastName}" has been enrolled with ID ${newCustomer.id}.`);
    setActiveTab('list');
  };
  ...
  return (
    <div className="premium-crm-container">
      {/* 1. Header Banner with Live Completion Progress */}
      <div className="crm-header-card">
        <div className="crm-title-area">
          <h2>Beha Customer Intake &amp; Lead Management</h2>
          <p>
            Capture detailed preferences, Ethiopian &amp; Diaspora buyer profiles, budget brackets, and property specifications.
          </p>
        </div>
