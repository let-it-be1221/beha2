        ...
        <div className="auth-body-container">
          ...
          {mode === 'login' ? (
            <form className="auth-form" onSubmit={handleLoginSubmit}>
              ...
              {/* Quick Role Tester per Articles 8–19 */}
              <div style={{ marginTop: '16px', paddingTop: '14px', borderTop: '1px dashed rgba(150, 150, 150, 0.3)' }}>
                <div style={{ fontSize: '11px', fontWeight: '700', color: '#64748b', textTransform: 'uppercase', marginBottom: '8px', textAlign: 'center' }}>
                  Quick Login Demo (Articles 8–19 Seeded Accounts)
                </div>
